...
For more on AlphaZero's origins, you can explore DeepMind's research <a href="https://deepmind.com/research/highlighted-research/alphago" target="__blank">here</a>.
...
The larger grid and increased winning condition require more strategic planning, providing the perfect setup to train an AlphaZero-inspired AI. If you're unfamiliar with the standard game rules, check out a simple explanation <a href="https://en.wikipedia.org/wiki/Tic-tac-toe" target="__blank">here</a>.
