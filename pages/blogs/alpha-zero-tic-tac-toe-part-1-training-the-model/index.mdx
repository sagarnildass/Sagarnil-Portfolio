...
export const meta = {
  ...
  date: "2024-11-30",
  title:
    "Training AlphaZero with Monte Carlo Tree Search: Building a Tic-Tac-Toe Champion (Part 1: Training the model)",
  description:
...
- **Part 3:** Creating a gorgeous, user-friendly frontend in <Link href="https://reactjs.org/" target="__blank" rel="noopener noreferrer">React</Link>, where you will play live against a super-human agent. Here you will see live updates to the Game Tree driven by Monte Carlo Tree Search and the trained policy and also get the probability of win at each move.
